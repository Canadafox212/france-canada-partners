...
| Donnée                        | Table                   | Nature                           |
| ----------------------------- | ----------------------- | -------------------------------- |
| Adresse courriel de connexion | `users`                 | Identifiant de compte            |
| Nom complet                   | `users`                 | Personnel                        |
| Consentements                 | `user_consents`         | Personnel (lié à un utilisateur) |
| Demandes RGPD/Loi 25          | `data_subject_requests` | Personnel (lié à un utilisateur) |
